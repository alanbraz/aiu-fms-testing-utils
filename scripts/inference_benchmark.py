...
if args.compile:
    ...
    benchmark_json["total_warmup_m"] = benchmark_json["pt_compile_s"] / 60
    ...
    if is_aiu_backend:
        ...
        benchmark_json["total_warmup_m"] += benchmark_json["update_lazyhandle_s"] / 60
    ...
    if args.device_type == "aiu":  # only run warmup for AIU, no need for senulator
        ...
        benchmark_json["total_warmup_m"] += benchmark_json["aiu_warmup_s"] / 60
